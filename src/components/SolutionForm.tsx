            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white border border-[#e9ecef] text-gray-800 placeholder-gray-400 focus:outline-hidden focus:border-[#1b4332] text-sm transition-colors font-semibold shadow-xs"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                ...
                <div className="space-y-1.5 animate-fade-in">
                  ...
                  <div className="grid grid-cols-3 gap-2 bg-[#f5f7f6] p-1.5 rounded-xl border border-[#e9ecef] shadow-xs" role="radiogroup" aria-labelledby="id-custo-est">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white border border-[#e9ecef] rounded-xl text-gray-800 text-xs focus:outline-hidden focus:border-[#1b4332] shadow-xs font-medium"
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-2 bg-[#f5f7f6] p-1.5 rounded-xl border border-[#e9ecef] shadow-xs" role="radiogroup" aria-labelledby="id-viabilidade-est">
