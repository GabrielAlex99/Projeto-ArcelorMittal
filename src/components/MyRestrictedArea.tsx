  ...
  return (
    <section id="restrito" className="py-20 bg-[#f5f7f6] border-t border-[#e9ecef] scroll-mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#e9ecef] rounded-3xl p-6 md:p-8 shadow-xs mb-10 text-left flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-5">
            <div className="bg-[#1b4332] text-white p-4.5 rounded-full shadow-md">
          ...
          <div className="flex space-x-4">
            <div className="bg-[#f5f7f6] border border-[#e9ecef] px-5 py-3.5 rounded-2xl shadow-2xs text-center">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-gray-150 mb-8 gap-4">
          ...
          {activeTab === 'relatos' && userRelatos.length > 0 && (
            <button
              ...
              className="bg-[#1b4332] hover:bg-[#133024] cursor-pointer text-white px-4 py-2.5 rounded-2xl text-xs font-bold flex items-center space-x-2 self-start md:self-auto mb-2 md:mb-0 transition-all shadow-xs"
        ...
        {activeTab === 'relatos' ? (
          ...
          <div className="space-y-4 text-left">
            {userRelatos.length > 0 ? (
              userRelatos.map((r) => (
                <div key={r.id} className="bg-white border border-[#e9ecef] rounded-2.5xl p-6 shadow-xs relative hover:border-[#1b4332]/25 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="space-y-3 max-w-full md:max-w-[70%]">
                    ...
                    <p className="text-gray-650 text-xs sm:text-sm leading-relaxed">{r.descricao}</p>
                  ...
                  <div className="flex md:flex-col items-center justify-end gap-2 shrink-0 pt-4 md:pt-0 border-t md:border-t-0 border-gray-100">
                    <button
                      ...
                      className="px-4 py-2 bg-gray-50 hover:bg-[#1b4332]/10 text-gray-700 hover:text-[#1b4332] rounded-xl text-xs font-bold border border-gray-200 hover:border-[#1b4332]/20 flex items-center space-x-1.5 transition-all shadow-2xs"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-rose-50 hover:bg-rose-100 text-rose-600 rounded-xl text-xs font-bold border border-rose-200 flex items-center space-x-1.5 transition-all shadow-2xs"
                    >
          ...
          <div className="space-y-4 text-left">
            {userPropostas.length > 0 ? (
              userPropostas.map((p) => (
                <div key={p.id} className="bg-white border border-[#e9ecef] rounded-2.5xl p-6 shadow-xs relative hover:border-[#1b4332]/25 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="space-y-3 max-w-full md:max-w-[70%]">
        ...
        {editingRelato && (
          <div className="fixed inset-0 z-55 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="bg-white border border-[#e9ecef] rounded-3.5xl max-w-lg w-full p-6 md:p-8 shadow-2xl relative text-left animate-scale-up max-h-[90vh] overflow-y-auto custom-scrollbar">
              ...
              <form onSubmit={handleSaveRelatoEdit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-xl bg-[#f5f7f6] border border-[#e9ecef] text-sm text-gray-850"
                  />
                </div>
              ...
              <form onSubmit={handleSavePropostaEdit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-xl bg-[#f5f7f6] border border-[#e9ecef] text-sm text-gray-850 font-bold"
                  />
                </div>
        ...
        {itemToDelete && (
          <div className="fixed inset-0 z-55 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="bg-white border border-[#e9ecef] rounded-3.5xl max-w-sm w-full p-6 shadow-2xl relative text-center animate-scale-up">
